...
const TRATTA_CITY = {
  numbered: [
    ...
    { n: 21, x: 20.1, y: 50.9, name: 'Shrine of Knowledge', type: 'shrine', desc: 'A small but respected shrine dedicated to the pursuit of knowledge. Scholars and scribes leave offerings here.' },
