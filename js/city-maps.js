 ...
 * Edit pin positions via the City Map tab in editor.html.
 * New cities are auto-discovered from images/cities/ by the server.
 * Add a new entry here once you've placed the images in images/cities/<id>/
 */
const CITY_MAPS = [
  {
    id: 'tratta',
