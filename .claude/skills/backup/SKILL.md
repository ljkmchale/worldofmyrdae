---
name: backup
description: Create a timestamped backup of key World of Myrdae source files (locations-db.js, map-overlay.js, editor.js) into the /backups/ directory before making significant changes
